...
(function(e) {
    ...
    function ba(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u, v, y, d, D, E, z) {
        ...
        b.responsiveRelativeToBrowser && (responsiveWidth = e(window).width(), responsiveHeight = e(window).height() / 1.5);
    ...
    e.fn.bannerscollection_zoominout = function (a) {
        ...
        return this.each(function() {
            ...
            a.responsiveRelativeToBrowser && (responsiveWidth = e(window).width(), responsiveHeight = e(window).height() / 1.5);
			// Height Modifyed by sumanta
            a.origWidth = a.width;
            ...
            var c = e("<div></div>").addClass("bannerscollection_zoominout").addClass(a.skin),
                ...
                //p = e('<div class="contentHolderVisibleWrapper"><div class="contentHolder"></div></div> <div class="playOver"></div> <div class="thumbsHolderWrapper"><div class="thumbsHolderVisibleWrapper"><div class="thumbsHolder"></div></div></div> <canvas class="mycanvas hide"></canvas>');
                p = e('<div class="bannerControls hidden-xs"> <div class="leftNav"></div> <div class="rightNav"></div> </div> <div class="contentHolderVisibleWrapper"><div class="contentHolder"></div></div> <div class="playOver"></div> <div class="thumbsHolderWrapper"><div class="thumbsHolderVisibleWrapper"><div class="thumbsHolder"></div></div></div> <canvas class="mycanvas hide"></canvas>');
            b.wrap(c);
            b.after(p);
            ...
            c = E();
            // a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'),  e("#zoominoutParent_" + p).height(a.height)), -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || (h.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move"), f.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move")), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
            //a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'), e("#zoominoutParent_" + p).height(a.height)), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
            //alert(a.height), sumanta
            a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'), e("#zoominoutParent_" + p).height(a.height)),
            //alert(a.height), sumanta
			h.css("left", "0"),
			a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({
